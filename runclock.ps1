...
# The build command
$publishCmd = "dotnet restore .\DesktopClock\DesktopClock.csproj -r win-x64 && msbuild .\DesktopClock\DesktopClock.csproj /t:publish /p:PublishDir=$toolsDir /p:Configuration=Release /p:RuntimeIdentifier=win-x64"
